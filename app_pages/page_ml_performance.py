...
def page_ml_performance_metrics_body():
    ...
    st.info("The **accuracy** and **loss** graphs below provide visualisation of the ML learning cycle.")
    ...
    st.write("---")
    st.write("###### *During model development, several models were trained and tested.")
    st.write("###### **Model_3** showed the best performance during evaluation.")
    st.write("###### For more information see [project documentation](https://github.com/DrSYakovlev/corals_health).")
